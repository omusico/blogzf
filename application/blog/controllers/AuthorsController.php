...
class AuthorsController extends Zend_Controller_Action
{
    ...
    public function preDispatch ()
    {
         ...
         */
        $this->view->headLink()->appendStylesheet($this->view->staticServer . 'layout/admin/css/style.css');
        /**
         ...
         */
        $this->_db = Zend_Db::factory($config->database->db->adapter, $config->database->db->config->toArray());
    }
